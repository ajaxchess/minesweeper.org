...
| 4 | 3a | Build Board component — render cells, mines, numbers, flags for all 3 board sizes | pending |
| 5 | 3b | Implement touch handling — tap, long-press, flag mode button, chord tap, pinch-to-zoom | pending |
