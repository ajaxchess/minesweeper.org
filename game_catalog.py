...
LANGUAGE_OPTIONS: list[dict[str, str]] = [
    ...
    {"code": "sv", "label": "SV", "name": "Svenska", "flag": "sv"},
...
PUZZLE_GAMES: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "section": "Daily Logic Puzzles",
        "title": "Meowdoku",
        "short_title": "Meowdoku",
        "icon": "🐱",
        "description": "A daily cat-placement logic puzzle. Put one cat in every colored region with no shared row, column, or diagonal.",
        "desc_key": "nav_sub_meowdoku",
        "nav_desc_key": "nav_sub_meowdoku",
        "canonical_path": "/puzzles/meowdoku",
        "play_path": "/puzzles/meowdoku",
        "how_to_play_path": "",
        "leaderboard_path": "",
        "legacy_paths": ["/meowdoku"],
        "url_prefix": "/meowdoku",
        "translated_slugs": {"en": "meowdoku"},
        "image": "/static/img/og-default.png",
        "og_image": "https://minesweeper.org/static/img/og-default.png",
        "schema_type": "VideoGame",
        "genre": ["Puzzle", "Logic", "Daily Puzzle"],
        "keywords": ["meowdoku", "cat puzzle", "daily logic puzzle", "queens puzzle"],
        "is_daily": True,
        "is_multiplayer": False,
        "is_indexable": True,
        "mode": "meowdoku",
        "primary_href": "/puzzles/meowdoku",
        "actions": [
            {"href": "/puzzles/meowdoku", "label_key": "other_daily_puzzle", "primary": True},
            {"href": "/puzzles/meowdoku/generator", "label_key": "other_generator"},
        ],
        "faq_items": [
            {"question": "What is Meowdoku?", "answer": "Meowdoku is a daily logic puzzle where you place one cat in every colored region so no two cats share a row, column, or diagonal."},
            {"question": "How many cats do I place?", "answer": "You place one cat per colored region — so on a 6×6 board you place 6 cats."},
        ],
        "how_to_steps": [
            "Each colored area must contain exactly one cat.",
            "No two cats can be in the same row or column.",
            "Cats cannot touch each other even diagonally.",
            "Every puzzle has a unique solution that can be found by logic alone.",
        ],
    },
]
