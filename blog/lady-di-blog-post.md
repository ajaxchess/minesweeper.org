...
If you're curious, the [Wayback Machine still has the original 2002 page](https://web.archive.org/web/20020408093155/http://www.minesweeper.org/). The old site had some security issues, so treat it as a museum piece — but it's all there: the Java applet, the daily scores, Diana's photo, and the HALO Trust banner.
...
**[minesweeper.org/?theme=diana](https://minesweeper.org/?theme=diana)**
...
Twenty-five years after I first put Diana's photo on a minesweeper website, the connection still feels right. Come play at [minesweeper.org](https://minesweeper.org/?theme=diana). And if you have a moment, think about why the game is called what it's called.
