...
# Introducing the 15-Puzzle on Minesweeper.org
...
The 15-Puzzle is available under the **Other Puzzles** section at [minesweeper.org/other](https://minesweeper.org/other), or head directly to [minesweeper.org/other/15puzzle](https://minesweeper.org/other/15puzzle/). No download or account required to play — though signing in with Google lets you save your scores and compete on the leaderboard.
