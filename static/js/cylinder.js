    ...
    if (won) {
      if (username) {
        ...
        scoreForm = `
          ...
          <div class="overlay-guest-warning">🎉 Congratulations! <a href="${loginHref}" onclick="guestLoginAndSave(event, '${loginHref}', 'cylSubmitScore', 'cyl-player-name')">Login with Google</a> or your score will vanish at 0:00 UTC.</div>
        `;
      }
    }
