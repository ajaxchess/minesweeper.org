...
This should be puzzle after puzzle 2...  Call it E1

Basic board editor: 
Hex board with R=3 | Select Tiles that are revealed | Select tiles with mines
...
no guesses.
Alerts if unsolvable without a guess.
